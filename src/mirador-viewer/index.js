...
(Mirador.viewer(
    {
      ...
      thumbnailNavigation: {
        ...
        height: 160, // height of entire ThumbnailNavigation area when position is "far-bottom"
        width: 140, // width of one canvas (doubled for book view) in ThumbnailNavigation area when position is "far-right"
      },
      themes: {
        light: {
          palette: {
